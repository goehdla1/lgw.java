...
public class Ex05 {
	public static void main(String[] args) {
		...
		// a - g
		for (char i = 'a'; i <= 'g'; i++) {
			// 출력 후 한 줄 띄우기. , \t 는 tab = (일정한 간격을 띄우는 것.)을 의미
			System.out.print(i + "\t");

		}
		// \n는 한줄 띄우기 ==> string 안에서만 사용 가능하다.
		System.out.print("가나\n다라");
		// 한 줄 띄우기
		System.out.println();

		// System.out.println(); : 줄 바꾸기
		// System.out.print(); = > 오류다. / 존재하지 않는 메소드
		...
		System.out.println("홀수,짝수의 합계: " + (even + odd));
