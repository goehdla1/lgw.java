...
public class Ex12 {
	public static void main(String[] args) {
		...
		// continue label : label이 지정한 블록 수행문을 포기하고 다음 회차로 진행
		// label 지정 방법 'label이름 ;' 뒤나 밑에는 반복문만 올 수 있다.
		...
		// for문이 하나일때는 break 와 break label 이 같은 결과를 낸다.
