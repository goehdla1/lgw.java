...
public class Ex10_main {
	public static void main(String[] args) {
		...
		// 입력하기.
		Ex10[] arr = new Ex10[5]; // 5명의 배열을 만들고.

		for (int i = 0; i < arr.length; i++) {
			Ex10 person = new Ex10(); // Ex09를 객체화 한거다. new 는 새로운 객체를 만드는것이다. for문을 써도 중복이되지 않는다.
		...
		//정렬
		Ex10 tmp = new Ex10(); // 임시 저장하는것도 클래스로 만들어야한다.
