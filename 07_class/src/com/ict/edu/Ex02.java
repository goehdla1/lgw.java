...
public class Ex02 {
	...
	public static void main(String[] args) {
		...
		// 11. contains(CharSequence s) : boolean , 인자 char 는 오류.
		...
		// 13. split(String regex, int limit ) : String[] => 배열로 나와서 for문으로 확인해야 된다.
		// split(String regex) : String[]
		// String regex : 구분자(나눔기준) , int limit => 나눌 배열의 크기.
		...
		// 17. toString() : String
		// Object의 toString() : 모든 객체에 사용 가능 , 객체가 가지고 있는 정보나 값들을 문자열로 만들어 리턴하는
		// 메소드(오버라이딩할때 배운다.)
		...
		System.out.println(bo1 + "");
		System.out.println((ch1) + "");
		System.out.println((num1) + ""); // => 각 자료형에서 String으로 변환 됬다. 야매방법.
		System.out.println((num2) + "");
		System.out.println((num3) + "");
		System.out.println(num4 + "");
		System.out.println("==========================================================================");

		// 20-1. Wrapper class : - 각 자료형의 형태를 가진 문자열을 진짜 자료형으로 변경시키는 클래스
		...
		message = "java 자바 JAVA 大韓民國 2020"; // 숫자로 변경(영어와 숫자만 가능)
