...
public class Ex01 {
	...
	// 대상 : 전세계 모든 언어로 구성된 문서 파일을 입출력할때 사용.
	// 최상위 클래스 : Reader(입력) , Writer(출력)

	// 3. 바이트-문자 스트림 결합 : 기계를 통해 입/출력한 정보를 사람이 사용할 수 있도록 입/출력
	// 해당 클래스 : InputStreamReader(입력) , OuputStreamWriter(출력)

	// 4. 오브젝트 스트림 ; 객체를 직렬화 한후 객체 단위로 입/출력
	// 해당클래스 : ObjectInputStream(readObject() : 객체 직렬화)
	// : ObjectOuputStream(writeObject() : 객체 역직렬화)
}
